...
def loopback_trend(persist_f, from_date, to_date, stop_loss, stop_benefit, min_up_days):
    """Rising trend
    """
    loopback = LoopbackTrend(persist_f, from_date, to_date, stop_loss, stop_benefit, min_up_days)
    loopback.init()
    loopback.best_stocks()
